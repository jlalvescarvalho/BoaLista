...
public class AlterarUsuarioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Fachada.getStance().alterarUsuario(usuario);
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AlterarUsuarioServlet</title>");            
            out.println("</head>");
            out.println("<body>");
           
            out.println("<h1>O Usuario "+usuario.getNome()+" Foi Alterado Com Sucesso</h1>");
             out.println("<a href=\"ListarUsuarios\">Voltar</a>");
