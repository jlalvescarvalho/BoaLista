...
public class ExcluirusuarioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Fachada.getStance().excluirUsuario(usuario);
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ExcluirusuarioServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            
             out.println("<h1>O Usuario: "+usuario.getNome()+" Foi Excluido Com Sucesso</h>");
            out.println("<br>");
